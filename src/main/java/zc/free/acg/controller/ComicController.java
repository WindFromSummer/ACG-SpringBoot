...
import zc.free.acg.mapper.ComicImgMapper;
...
//        int i = this.comicImgMapper.insertSelective(comicImg);
    ...
    public String queryComicImg(Model model) {
        ComicImgExample comicImgExample = new ComicImgExample();
        List<ComicImg> comicImgs = this.comicImgMapper.selectByExample(comicImgExample);
