...
//import zc.free.acg.domain.ExhibitionDetails;
...
//        record.setId(1);
//        List<ExhibitionDetails> select = this.exhibitionDetailsMapper.select(record);
//        ExhibitionDetails details = select.get(0);
