...
//替换成你的AK
        final String accessKeyId = "LTAI4FomDSdvXyJK1meAKYhw";//你的accessKeyId,参考本文档步骤2
        final String accessKeySecret = "POp1U9ePiSLEGgSnvXLzpYxN7UMJLd";//你的accessKeySecret，参考本文档步骤2
